<form role="form" action="<?=$accion?>" method="post">
    <div class="form-group <?=(isset($claseCampoForm['cod_envio']))?$claseCampoForm['cod_envio']:''?>">
    ...
    <div class="form-group <?=(isset($claseCampoForm['destinatario']))?$claseCampoForm['destinatario']:''?>">
    ...
    <div class="form-group <?=(isset($claseCampoForm['telefono']))?$claseCampoForm['telefono']:''?>">
    ...
    <div class="form-group <?=(isset($claseCampoForm['direccion']))?$claseCampoForm['direccion']:''?>">
    ...
    <div class="form-group <?=(isset($claseCampoForm['poblacion']))?$claseCampoForm['poblacion']:''?>">
    ...
    <div class="form-group <?=(isset($claseCampoForm['cod_postal']))?$claseCampoForm['cod_postal']:''?>">
    ...
    <div class="form-group <?=(isset($claseCampoForm['provincia']))?$claseCampoForm['provincia']:''?>">
    ...
    <div class="form-group <?=(isset($claseCampoForm['email']))?$claseCampoForm['email']:''?>">
    ...
    <div class="form-group <?=(isset($claseCampoForm['observaciones']))?$claseCampoForm['observaciones']:''?>">
